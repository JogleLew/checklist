    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                ...
                backToMainIntent.setClass(AddItemActivity.this, ItemListActivity.class);
        ...
        sureButton.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                if (data.getYear() == 0){
                    ...
                    sureIntent.setClass(AddItemActivity.this, ItemListActivity.class);
        ...
        chooseTimeButton.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                ...
                chooseTimeIntent.setClass(AddItemActivity.this, TimePickForAddActivity.class);
        ...
        chooseImageButton.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                ...
                chooseImageIntent.setClass(AddItemActivity.this, ImagePickForAddActivity.class);
        ...
        new AlertDialog.Builder(this)
                ...
                .setItems(theme, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int i) {
                        ...
                        themeIntent.setClass(AddItemActivity.this, AddItemActivity.class);
