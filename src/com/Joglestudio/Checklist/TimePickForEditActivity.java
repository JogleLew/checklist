 ...
 */
public class TimePickForEditActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (i == -1){
            ...
            backToEdit2Intent.setClass(TimePickForEditActivity.this, EditItemActivity.class);
            backToEdit2Intent.putExtra("position", pos);
            startActivity(backToEdit2Intent);
            overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out);
            TimePickForEditActivity.this.finish();
        }
        ...
        sureChooseTimeButton.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                ...
                sureChooseTimeIntent.setClass(TimePickForEditActivity.this, EditItemActivity.class);
    ...
    private void showMenu(){
        new AlertDialog.Builder(TimePickForEditActivity.this)
                .setTitle("设定")
        ...
        new AlertDialog.Builder(this)
                ...
                .setItems(theme, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int i) {
                        ...
                        themeIntent.setClass(TimePickForEditActivity.this, TimePickForEditActivity.class);
