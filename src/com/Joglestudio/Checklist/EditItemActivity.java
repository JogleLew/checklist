...
public class EditItemActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pos = i;
        String s;
        if (isFileExists("editing" + i + ".dat"))
            s = readFileData("editing" + i + ".dat");
        else {
            s = readFileData(i + ".dat");
            writeFileData("editing" + i + ".dat", s);
        }
        ...
        back2Button.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                ...
                backToMain2Intent.setClass(EditItemActivity.this, ItemListActivity.class);
                deleteTheFile("editing" + pos + ".dat");
        ...
        sureEditButton.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                ...
                sureEditIntent.setClass(EditItemActivity.this, ItemListActivity.class);
                ...
                deleteFile(pos + ".dat");
                renameFile("editing" + pos + ".dat", pos + ".dat");
        ...
        chooseTime2Button.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                ...
                chooseTime2Intent.setClass(EditItemActivity.this, TimePickForEditActivity.class);
                TextView itemName = (TextView) findViewById(R.id.edittext2);
                data.setItemName(itemName.getText().toString());
                String s = DataModel.getPackedString(data);
                writeFileData("editing" + pos + ".dat", s);
        ...
        chooseImage2Button.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                ...
                chooseImage2Intent.setClass(EditItemActivity.this, ImagePickForEditActivity.class);
                TextView itemName = (TextView) findViewById(R.id.edittext2);
                data.setItemName(itemName.getText().toString());
                String s = DataModel.getPackedString(data);
                writeFileData("editing" + pos + ".dat", s);
                ...
                new AlertDialog.Builder(EditItemActivity.this)
                        ...
                        .setNegativeButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                deleteItemIntent.setClass(EditItemActivity.this, ItemListActivity.class);

                                deleteFile(pos + ".dat");
                                deleteFile("editing" + pos + ".dat");
                                String numString = readFileData("count.dat");
                                int num = Integer.parseInt(numString);
                                for (int i = pos + 1; i < num; i++)
                                    renameFile(i + ".dat", (i - 1) + ".dat");
                                num--;
                                writeFileData("count.dat", num + "");
        ...
        new AlertDialog.Builder(this)
                ...
                .setItems(theme, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int i) {
                        ...
                        themeIntent.setClass(EditItemActivity.this, EditItemActivity.class);
