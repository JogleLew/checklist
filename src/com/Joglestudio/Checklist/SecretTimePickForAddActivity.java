 ...
 */
public class SecretTimePickForAddActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (i == -1){
            ...
            backToEdit2Intent.setClass(SecretTimePickForAddActivity.this, SecretItemListActivity.class);
            backToEdit2Intent.putExtra("position", pos);
            startActivity(backToEdit2Intent);
            overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out);
            SecretTimePickForAddActivity.this.finish();
        }
        ...
        backToAddButton.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                ...
                backToAdd2Intent.setClass(SecretTimePickForAddActivity.this, SecretAddItemActivity.class);
        ...
        sureChooseTimeButton.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                ...
                sureChooseTimeIntent.setClass(SecretTimePickForAddActivity.this, SecretAddItemActivity.class);
    ...
    private void showMenu(){
        new AlertDialog.Builder(SecretTimePickForAddActivity.this)
                .setTitle("设定")
        ...
        new AlertDialog.Builder(this)
                ...
                .setItems(theme, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int i) {
                        ...
                        themeIntent.setClass(SecretTimePickForAddActivity.this, SecretTimePickForAddActivity.class);
